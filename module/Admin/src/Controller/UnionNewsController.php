...
class UnionNewsController extends AbstractActionController
{
    private $em;
    ...
    public function addAction(){
        $form = new \Admin\Form\UnionNews($this->em);
        ...
        if($request->isPost()){
            ...
            if($form->isValid()){
                ...
                $entity = new \Admin\Entity\UnionNews();
    ...
    public function editAction(){
        ...
        $entity = $this->em->find('Admin\Entity\UnionNews', $id);
    ...
    public function get($id = false){
        if($id){
            return $this->em->createQuery('SELECT a FROM Admin\Entity\UnionNews a WHERE a.id = :id')->setParameter('id', $id)->getResult(\Doctrine\ORM\Query::HYDRATE_ARRAY);
        }else{
            return $this->em->createQuery('SELECT p FROM Admin\Entity\UnionNews p ORDER BY p.id DESC')->getResult(\Doctrine\ORM\Query::HYDRATE_ARRAY);
        }
    }
