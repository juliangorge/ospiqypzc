...
class NewsController extends AbstractActionController
{
    ...
    public function get($id = false){
        if($id){
            return $this->em->createQuery('SELECT a FROM Admin\Entity\News a WHERE a.id = :id')->setParameter('id', $id)->getResult(\Doctrine\ORM\Query::HYDRATE_ARRAY);
        }else{
            return $this->em->createQuery('SELECT p FROM Admin\Entity\News p ORDER BY p.id DESC')->getResult(\Doctrine\ORM\Query::HYDRATE_ARRAY);
        }
    }
